...
func usage() {
    fmt.Printf("Usage: core [-c filename]\n\nOptions:\n")
    flag.PrintDefaults()
}
...
func welcome() {
    ...
    fmt.Println("        /____/                              ")
    fmt.Println("")
    outputInfo("Service", "core")
    outputInfo("Version", core.Version)
}
...
func main() {
    ...
    cfg := &core.Config{
        ...
        Core: &core.CoreConfig{
            LocalSpace: configOrDefault("core", "local_space", "~/.core"),
            RemoteSpace: configOrDefault("core", "remote_space", "~/.core"),
            Cipher: configOrDefault("core", "cipher_key", ""),
            AppHost: configOrDefault("core", "app_host", ""),
        },
        Mail: &core.MailConfig{
    ...
    if err := core.App.Init(cfg); err != nil {
        log.Fatal(err)
    }
